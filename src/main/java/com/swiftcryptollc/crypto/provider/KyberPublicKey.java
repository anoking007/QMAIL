 ...
 */
public final class KyberPublicKey implements PublicKey, com.swiftcryptollc.crypto.interfaces.KyberPublicKey, Serializable {

    static final long serialVersionUID = generateRandomSerialVersionUID();

    private static long generateRandomSerialVersionUID() {
     ...
     * Kyber public key
     */
    public KyberPublicKey(byte[] encodedKey) throws InvalidKeyException {
